<template>
  <el-container class="app">
    <el-aside width="220px"><div class="brand">扫描中心</div><el-menu router :default-active="$route.path" background-color="#17233d" text-color="#bfcbd9" active-text-color="#fff">
      ...
      <el-menu-item index="/tasks"><i class="el-icon-s-operation"></i>扫描任务中心</el-menu-item>
      <el-menu-item index="/results"><i class="el-icon-data-analysis"></i>扫描结果</el-menu-item>
